...
const Pagination = () => {
  ...
  const renderUsers = () => {
    if (!loading)
      return (
        <p className="text-center text-2xl font-bold mx-auto">loading ... </p>
      );
    return (
      <div >
        <ToastContainer
        ...
        {showPage &&
          showPage.map((item) => {
            return (
              <div
                key={item.id}
                className="shadow shadow-xl transform  duration-200 hover:scale-110 my-[20px] bg-white flex flex-col items-center justify-center  pt-[10%] rounded-[10px]">
                ...
                <div className="my-3 text-center flex flex-col justify-between ">
                  ...
                  <h1 className="w-full px-[30px] text-center mx-auto text-justify">
                    $ {item.title}
                  </h1>
                </div>
                <div className="my-5">
                  <button
                    ...
                    className="px-[6px] py-[5px] bg-[#6d28d9] hover:cursor-pointer rounded  text-[#f6f6f6]">
                    {toggle(item) ? "in cart" : "Add to cart"}
                  </button>
      ...
      <div className="px-[10%]">
        <div>
          ...
          <p>
            ...
            nulla modi rem quasi reprehenderit rerum ex illum distinctio hic
            ipsa mollitia odit ducimus nemo enim alias, eveniet, magnam neque ad
            labore repellendus atque amet vel, similique ea! Dolores dolor cum
            nam cupiditate obcaecati animi commodi eius blanditiis, repellendus
            facilis{" "}
          </p>
        </div>
        <div className="my-5">
          <ul>
            <li className="text-2xl my-2">Variety of products</li>
            <li>fast sending</li>
          ...
          <NavLink to="/contactus">
            <button className="px-[6px] my-5 py-[5px] bg-[#6d28d9] hover:cursor-pointer rounded text-[#f6f6f6]">
              contact us
            </button>
          </NavLink>
        </div>
        <div className="w-full">
          <h1 className="text-3xl my-5 text-[#6d28d9]">
            do your first shop now{" "}
          </h1>
          <div className="flex flex-col my-10 items-center lg:flex-row w-full justify-between bg-white rounded p-5 ">
            ...
            <NavLink to="/product">
              <button className="px-[6px] mb-10 mt-5 py-[5px] bg-[#6d28d9] hover:cursor-pointer rounded text-[#f6f6f6]">
                product
              </button>
            </NavLink>
          </div>
