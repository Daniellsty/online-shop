          ...
          <div  className="flex items-center my-20 mb-[150px] px-5 mx-auto text-center justify-center">
            {buttons.map((number)=>{
              ...
              <div className=" text-center mx-[1%]"  key={number} >
                ...
                <button  onClick={()=> setNumber(number)}  className={ `${perPage === number ? 'text-slate-800 border-[2px] border-[#ece9e9]' :null } border rounded   mx-[5px] px-[10px] py-[5px]  bg-[#6d28d9] text-white`  }  >{number}</button>
                </li>
